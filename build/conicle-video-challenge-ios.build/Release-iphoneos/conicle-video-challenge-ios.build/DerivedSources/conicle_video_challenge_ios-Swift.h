...
#ifndef CONICLE_VIDEO_CHALLENGE_IOS_SWIFT_H
#define CONICLE_VIDEO_CHALLENGE_IOS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="conicle_video_challenge_ios",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC27conicle_video_challenge_ios11AppDelegate")
...
SWIFT_CLASS("_TtC27conicle_video_challenge_ios28CustomAVPlayerViewController")
...
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified controlsContainerView;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified playPauseButton;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified pipButton;
...
- (IBAction)playPauseButtonTapped:(id _Nonnull)sender;
- (IBAction)sliderValueChanged:(UISlider * _Nonnull)sender;
- (IBAction)pipButtonTapped:(id _Nonnull)sender;
...
@interface CustomAVPlayerViewController (SWIFT_EXTENSION(conicle_video_challenge_ios)) <AVPictureInPictureControllerDelegate>
...
SWIFT_CLASS("_TtC27conicle_video_challenge_ios18HomeViewController")
...
@interface HomeViewController (SWIFT_EXTENSION(conicle_video_challenge_ios)) <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC27conicle_video_challenge_ios13SceneDelegate")
...
SWIFT_CLASS("_TtC27conicle_video_challenge_ios25VideoPlayerViewController")
...
SWIFT_CLASS("_TtC27conicle_video_challenge_ios27VideoPlaylistViewController")
...
@interface VideoPlaylistViewController (SWIFT_EXTENSION(conicle_video_challenge_ios)) <UITableViewDataSource, UITableViewDelegate>
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
- (void)tableView:(UITableView * _Nonnull)tableView didSelectRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
@end
